...
<body>
    <div class="card">
        <span class="mt-code">MENSAJE DE SISTEMA: FL103</span>
        <h1>Acceso Privado</h1>
        <div class="divider"></div>
        <p>Lo sentimos, no tienes permisos para acceder a esta página.</p>
        <p>Debes iniciar sesión para continuar.</p>
<p style="font-size: 0.8em; color: #999;">ID de Seguimiento: FL103-{{ strtoupper(Str::random(5)) }}</p>        <p style="font-size: 0.8em; color: #999;">Error: Lack of Privileges - Transacción Abortada.</p>
        <div class="divider"></div>
