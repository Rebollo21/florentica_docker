...
<body>
    <div class="card">
        <span class="mt-code">MENSAJE DE SISTEMA: Error FL207</span>
        <h1>Acceso Privado</h1>
        <div class="divider"></div>
        <p>Lo sentimos, <strong>{{ auth()->user()->name }}</strong>.</p>
<p>La sesión actual no cuenta con los privilegios necesarios para acceder a esta página.</p>
<p style="font-size: 0.8em; color: #999;">ID de Seguimiento: FL207</p>        <p style="font-size: 0.8em; color: #999;">Error: Lack of Privileges - Transacción Abortada.</p>
        <div class="divider"></div>
